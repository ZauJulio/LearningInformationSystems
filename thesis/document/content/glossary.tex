...
FA    \dotfill {\it Features Analyzer}

GUI   \dotfill {\it Graphical User Interface}

GTK   \dotfill {\it GIMP Toolkit}

CSV   \dotfill {\it Comma Separated Values}

XLSX   \dotfill {\it Excel Open XML Spreadsheet}

API   \dotfill {\it Application Programming Interface}

SDK   \dotfill {\it Software Development Kit}

PVM   \dotfill {\it Python Virtual Machine}

JIT   \dotfill {\it Just-In-Time}

SVG   \dotfill {\it Scalable Vector Graphics}

JSON  \dotfill {\it JavaScript Object Notation}

PO    \dotfill {\it Portable Object (GNU Gettext)}

SQL   \dotfill {\it Structured Query Language}

NoSQL \dotfill {\it Not Only SQL}

ORM   \dotfill {\it Object-Relational Mapping}

MLP   \dotfill {\it Multi-Layer Perceptron}

KMEANS  \dotfill {\it K-Means Clustering}
